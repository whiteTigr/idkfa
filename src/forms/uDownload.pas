...
const
  LoadDataMemoryProgramm: array[0..47] of byte = (
    41, 23, 0, 0, 0, 0, 0, 0, 0, 32, 0, 32, 0, 39, 12, 32,
    61, 29, 38, 12, 8, 36, 32, 15, 32, 43, 29, 22, 9, 27, 33, 13,
    32, 0, 32, 42, 25, 7, 39, 0, 32, 28, 3, 11, 0, 13, 45, 23);
var
  i: integer;
begin
  SendBufferPtr := 0;
